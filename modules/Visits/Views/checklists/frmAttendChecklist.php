  ...
  <div class="card">
    <div class="card-body">
      ...
      <hr>
        <div class="row">
          <div class="col-md-12">
              <form id="formId" action="<?= base_url() ?>checklists/attend" method="post" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have agree to the Terms of Agreement'); return false; }">
                  <div class="row">
