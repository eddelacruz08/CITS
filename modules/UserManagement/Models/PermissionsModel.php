...
class PermissionsModel extends \CodeIgniter\Model
{
    ...
    protected $allowedFields = ['name_on_class', 'function_name', 'function_description','slugs','page_title','module_id','allowed_roles','status', 'created_date','updated_date', 'deleted_date'];
